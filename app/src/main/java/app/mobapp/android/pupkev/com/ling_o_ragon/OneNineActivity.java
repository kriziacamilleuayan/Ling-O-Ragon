 ...
 */
public class OneNineActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.one_nine);
    ...
    public void onBackPressed() {
        ...
        mp.start();
        AlertDialog.Builder a_builder = new AlertDialog.Builder(OneNineActivity.this);
        a_builder.setTitle("Continue?")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mp.start();
                        Intent nextform = new Intent(OneNineActivity.this, LevelOneActivity.class);
        ...
        button_next.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mp.start();
                        if (txt_ans.getText().toString().toLowerCase().equals("salamat")){
                            ...
                            Intent nextForm = new Intent(OneNineActivity.this, OneTenActivity.class);
                            startActivity(nextForm);
                            ...
                            alert.setMessage("The correct translation is 'Salamat.'"); //Message here
