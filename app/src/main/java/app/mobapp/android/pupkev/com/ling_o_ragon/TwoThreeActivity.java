 ...
 */
public class TwoThreeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.two_three);
    ...
    public void onBackPressed() {
        ...
        a_builder.setTitle(R.string.cont)
                ...
                .setNegativeButton(R.string.no, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mp.start();
                        Intent nextform = new Intent(TwoThreeActivity.this, LevelOneActivity.class);
        ...
        button_next.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mp.start();
                        if (txt_ans.getText().toString().toLowerCase().equals("sampung malalaking isda")){
