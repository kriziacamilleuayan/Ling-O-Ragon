 ...
 */
public class ThreeSevenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.three_seven);
    ...
    public void onBackPressed() {
        ...
        mp.start();
        AlertDialog.Builder a_builder = new AlertDialog.Builder(ThreeSevenActivity.this);
        a_builder.setTitle(R.string.cont)
                ...
                .setNegativeButton(R.string.no, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mp.start();
                        Intent nextform = new Intent(ThreeSevenActivity.this, LevelOneActivity.class);
        ...
        button_next.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mp.start();
                        if (txt_ans.getText().toString().toLowerCase().equals("madilim")){
                            ...
                            Intent nextForm = new Intent(ThreeSevenActivity.this, ThreeEightActivity.class);
                            startActivity(nextForm);
                            ...
                            alert.setMessage(R.string.tthreeseven); //Message here
