 ...
 */
public class OneTenActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.one_ten);
    ...
    public void onBackPressed() {
        ...
        mp.start();
        AlertDialog.Builder a_builder = new AlertDialog.Builder(OneTenActivity.this);
        a_builder.setTitle("Continue?")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mp.start();
                        Intent nextform = new Intent(OneTenActivity.this, LevelOneActivity.class);
        ...
        button_next.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mp.start();
                        if (txt_ans.getText().toString().toLowerCase().equals("patawarin mo ako") || txt_ans.getText().toString().equals("patawarin")){
                            ...
                            Intent nextForm = new Intent(OneTenActivity.this, OneElevenActivity.class);
                            startActivity(nextForm);
                            ...
                            alert.setMessage("The correct translation is 'Patawarin mo ako.'"); //Message here
